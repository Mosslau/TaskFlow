...
| [docs/UI设计规范-v1.0.md](docs/UI设计规范-v1.0.md) | UI 设计规范（设计令牌、组件与页面规范、Element Plus 主题落地，已终审通过） |
| [docs/实施计划-v1.0.md](docs/实施计划-v1.0.md) | 实施计划（M0-M6 里程碑任务拆解与验收标准，已终审通过） |
| [docs/里程碑-M0-工程脚手架.md](docs/里程碑-M0-工程脚手架.md) | M0 里程碑报告（完成进度、项目现状、启动指南、验证方式、踩坑记录） |
| [docs/本地中间件.md](docs/本地中间件.md) | 本地中间件连接信息与端口分配 |
